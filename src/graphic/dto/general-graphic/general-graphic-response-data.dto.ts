...
export class GeneralGraphicResponseDataDTO {
    ...
    static build({ month,
        ...
        expenses,
        ballance,
        totalBallance }: GeneralGraphicResponseDataDTO): GeneralGraphicResponseDataDTO {
        return new GeneralGraphicResponseDataDTO(month, earnings, expenses, ballance, totalBallance)
